...
class PharmacyPublicApiTests(APITestCase):
    def setUp(self):
        Pharmacy.objects.create(name_en='Vita Pharmacy', address_en='Ul. 1', city='Skopje', is_active=True)
        Pharmacy.objects.create(name_en='Closed Pharmacy', address_en='Ul. 2', city='Skopje', is_active=False)
